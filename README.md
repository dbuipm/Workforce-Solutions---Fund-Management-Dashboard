...
| | Approach | README |
|---|---|---|
| 1 | Live Salesforce connector → Power BI | [README_LiveConnection.md](./README_LiveConnection.md) |
| 2 | Salesforce API → Fabric Lakehouse → Python/SQL → Warehouse → Power BI | [README_ELT_Fabric.md](./README_ELT_Fabric.md) |
